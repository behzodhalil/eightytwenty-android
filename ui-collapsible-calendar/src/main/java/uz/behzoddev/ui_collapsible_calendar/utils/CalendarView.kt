...
import uz.behzoddev.ui_collapsible_calendar.ExpandIconView
import uz.behzoddev.ui_collapsible_calendar.LockScrollView
import java.util.*

@SuppressLint("ClickableViewAccessibility")
abstract class CustomCalendarView constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : ScrollView(context, attrs, defStyleAttr) {
    ...
    init {
        ...
        val rootView = mInflater.inflate(R.layout.view_holder_calendar, this, true)
